...
import { deleteQueryBatch, DELETE_POST, GET_IMAGE_BANNER, IMAGE_REFERENCE, LIKE_POST, POST_REFERENCE, REPORT_COMMENT_REFERENCE, REPORT_POST } from '../api/Firestore'
...
const CommentReportScreen = ({ navigation, route }) => {
    ...
    React.useEffect(() => {
        return REPORT_COMMENT_REFERENCE.orderBy('timestamp').onSnapshot((querySnapshot) => {
            const list = [];

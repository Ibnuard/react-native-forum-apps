...
import { deleteQueryBatch, DELETE_POST, GET_IMAGE_BANNER, IMAGE_REFERENCE, LIKE_POST, POST_REFERENCE, REPORT_POST, REPORT_REFERENCE } from '../api/Firestore'
...
const PostReportScreen = ({ navigation, route }) => {
